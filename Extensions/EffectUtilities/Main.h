// Object identifier "EUTL" 
#define IDENTIFIER	MAKEID(E,U,T,L)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
...
//	rSpr			rs;				// Sprite (displayable objects)
	...
	EffectUtilities* pEffectUtilities;	
