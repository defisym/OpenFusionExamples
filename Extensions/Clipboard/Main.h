// Object identifier "CFCB"
#define IDENTIFIER	MAKEID(C,F,C,B)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
...
// ---------------------------
#define	ACT_ACTION_S				0
#define	ACT_ACTION_L				1
