...
short actionsInfos[]=
		{
		IDMN_ACTION_S, M_ACTION_S,	ACT_ACTION_S,	0, 2, PARAM_FILENAME2, PARAM_EXPSTRING, 0, M_ACT_FORMAT,
		IDMN_ACTION_L, M_ACTION_L,	ACT_ACTION_L,	0, 2, PARAM_FILENAME2, PARAM_EXPSTRING, 0, M_ACT_FORMAT,
		};
