...
short conditionsInfos[]=
		{
		IDMN_CONDITION_ISEMBED, M_CONDITION_ISEMBED, CND_CONDITION_ISEMBED, EVFLAGS_ALWAYS | EVFLAGS_NOTABLE, 1, PARAM_EXPSTRING, M_ACTION_EXTRACTBINARYFILE_SRC,
		IDMN_CONDITION_DOWNLOADERROR, M_CONDITION_DOWNLOADERROR, CND_CONDITION_DOWNLOADERROR, 0, 1, PARAM_EXPSTRING, M_ACTION_DOWNLOAD_URL,
		IDMN_CONDITION_DOWNLOADCOMPLETE, M_CONDITION_DOWNLOADCOMPLETE, CND_CONDITION_DOWNLOADCOMPLETE, 0, 1, PARAM_EXPSTRING, M_ACTION_DOWNLOAD_URL,
		};
...
short actionsInfos[]=
		...
		IDMN_ACTION_DOWNLOAD, M_ACTION_DOWNLOAD, ACT_ACTION_DOWNLOAD, 0, 3, PARAM_EXPSTRING, PARAM_EXPSTRING, PARAM_EXPSTRING, M_ACTION_DOWNLOAD_URL, M_ACTION_DOWNLOAD_FOLDER, M_ACTION_DOWNLOAD_FILENAME,
...
long WINAPI DLLExport Condition_DownloadError(LPRDATA rdPtr, long param1, long param2) {
	return TRUE;
}
long WINAPI DLLExport Condition_DownloadComplete(LPRDATA rdPtr, long param1, long param2) {
	return TRUE;
}
...
short WINAPI DLLExport Action_DownloadFile(LPRDATA rdPtr, long param1, long param2) {
	return 0;
}
