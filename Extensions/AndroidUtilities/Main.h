// Object identifier "AUTL"
#define IDENTIFIER	MAKEID(A,U,T,L)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
...
// -------------------------------
#define	EXP_EXPRESSION_GETBINARYFILEPATH				0
